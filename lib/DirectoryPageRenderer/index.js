module.exports = function(req,res,next){
	...
	if(res.statusCode != 202){next(err); return;}
	...
	//Main Declaration
	var dirpath = req.realpath;

	var fsstat = fs.statSync(dirpath);
	
	if(!res.finished) if(fsstat.isDirectory()){
		...
		var ejs_prop = {global,err,req,res,next,dirpath,dirlist,webpath:req.path};
		var ejs_opt = {};
